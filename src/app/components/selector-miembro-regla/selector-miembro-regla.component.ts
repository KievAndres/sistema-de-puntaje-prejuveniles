...
export class SelectorMiembroReglaComponent {
  ...
  //     const listaMiembrosFiltrado = this.listaMiembros.filter(
  //       (miembro) =>
  ...
  //   this.listaMiembrosSeleccionados = this.listaMiembrosSeleccionados.filter(
  //     (miembroSeleccionado) =>
  //       miembroSeleccionado.idMiembroEquipo !== miembroABorrar.idMiembroEquipo
  //   );
  // }
